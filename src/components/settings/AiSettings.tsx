...
export function AiSettings() {
  ...
  const commitApiKey = useCallback(
    (raw: string) => {
      ...
      void patchAi({ aiApiKey: next }).catch(() => toast.error(t('settings.vault.saveFailed')))
    },
    [ai, patchAi, t],
  )
          ...
          <>
            ...
            >
              <Input
                ...
                onChange={(e) => setRuntimePortDraft(e.currentTarget.value)}
                onBlur={(e) => {
                  const next = normalizeAiRuntimePort(e.currentTarget.value)
            ...
            >
              <div className="flex max-w-xl flex-col gap-2">
                ...
                <Input
                  ...
                  onBlur={(e) => {
                    const next = normalizeAiModel(ai.aiProvider, e.currentTarget.value)
                    setModelDraft(next)
