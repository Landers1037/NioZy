...
export function SidebarTabList({ collapsed }: SidebarTabListProps) {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      {inGroupView && activeGroup && !collapsed ? (
        <div className="flex items-center gap-1 border-b border-border px-2 py-1.5 no-drag">
          <Button
            variant="ghost"
            size="icon"
      ...
      {inGroupView && activeGroup && collapsed ? (
        <div className="flex justify-center border-b border-border py-1.5 no-drag">
          <Button
            variant="ghost"
            size="icon"
            className="size-7"
