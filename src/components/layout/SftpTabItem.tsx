...
import { FolderOpen, Waypoints, X } from 'lucide-react'
import {
  ContextMenu,
  ContextMenuContent,
  ContextMenuItem,
...
export function SftpTabItem({
  ...
  const row = (
    ...
    >
      <Waypoints className={cn('shrink-0', iconOnly ? 'size-3' : 'size-4')} />
      {!compact && (
        <>
