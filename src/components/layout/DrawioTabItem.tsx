...
import { LineSquiggle, FolderOpen, X } from 'lucide-react'
import {
  ContextMenu,
  ContextMenuContent,
  ContextMenuItem,
...
export function DrawioTabItem({
  ...
  const row = (
    ...
    >
      <LineSquiggle className={cn('shrink-0', iconOnly ? 'size-3' : 'size-4')} />
      {!compact && (
        <>
