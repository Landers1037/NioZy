...
import { FolderOpen, Forklift, X } from 'lucide-react'
import {
  ContextMenu,
  ContextMenuContent,
  ContextMenuItem,
...
export function FtpTabItem({
  ...
  const row = (
    ...
    >
      <Forklift className={cn('shrink-0', iconOnly ? 'size-3' : 'size-4')} />
      {!compact && (
        <>
