...
export function StatusPanelSlider() {
  ...
  const { progress, onHandlePointerDown } = useStatusPanelDrag(panelWidth)
    ...
    >
      ...
      <button
        ...
        className={cn(
          ...
          'rounded-full border border-border/80 bg-background text-sm font-mono text-foreground',
      ...
      >
        <span aria-hidden className="tracking-tighter opacity-80">
          &lt;&gt;
        </span>
      </button>
    </div>
