...
- 明暗主题 `light` / `dark`
- UI 风格：`minimal` | `niozy` | `windowsClassic` | `waFu` | `cyberpunk` | `liquidGlass`
...
国际化：`src/lib/i18n.ts`、`src/locales/zh.json` 等（`tab.addToGroup`、`tab.enterGroup`、`tab.closeGroup` 等键）。
