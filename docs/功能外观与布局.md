...
国际化：`src/lib/i18n.ts`、`src/locales/zh.json` 等（`uiStyle.glass`、`uiStyle.neumorphism`、`settings.appearance.enableDialogAnimations`、`tab.addToGroup`、`tab.enterGroup`、`tab.closeGroup` 等键）。
